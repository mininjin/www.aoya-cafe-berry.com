<template>
  <div class="py-10 overflow-hidden w-full">
    <div :class="` transition-all duration-2000 ${bentoOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      ...
      <div class="flex items-stretch">
        ...
        <div class="w-4/6 py-3">
          ...
          <p class="mb-2">
            ご注文は<a class="inline underline" href="tel:0857-86-0515">お電話</a>・<a class="inline underline"
              href="sms:090-7998-4660">SMS</a>
    ...
    <div class="mt-10 p-2 md:flex w-full justify-center space-x-3" ref="horsDoevreContainer">
      <div class="flex h-52">
        <div class="flex-grow"></div>
        <img src="@/assets/images/bento/hors_doevre.webp" alt="オードブル" :class="`h-full object-contain rounded-lg transition-all duration-2000 transform md:transform-none ${horsDoevreOpen
          ? 'translate-x-0'
          : 'translate-x-1/2 md:-translate-x-1/2'
        }`" />
      </div>
      <div class="flex h-52 -translate-y-10 md:translate-y-0">
        <img src="@/assets/images/bento/hors_doevre_red.webp" alt="皿盛り" :class="`h-full object-contain rounded-lg transition-all duration-2000 transform md:transform-none ${horsDoevreOpen
          ? 'translate-x-0'
          : '-translate-x-1/2 md:translate-x-1/2 '
        }`" />
        <div class="flex-grow"></div>
    ...
    <div class="flex items-stretch">
      ...
      <div class="w-4/6 py-3">
        ...
        <p class="mb-2">
          宴会用の皿盛り・オードブルもたいへん人気です。こちらも<a class="inline underline" href="tel:0857-86-0515">お電話</a>・<a
            class="inline underline" href="sms:090-7998-4660">SMS</a>
